...
const coursesData: Omit<Course, 'id'>[] = [
    ...
    { name: 'Advanced Brows', description: 'Професійний курс підвищення кваліфікації для бровістів. Освоїть сучасні техніки архітектури, колористики та довготривалої укладки. Включає роботу зі складними випадками та створення трендових ефектів.', image: '', teacherId: '', teacherName: 'Nurgül Esenakunova', duration: '2 дні', price: 250, startDate: '2026-04-10', type: 'Workshop' },
];
